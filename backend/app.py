...
async def process_image(file: UploadFile = File(...)):
    ...
    try:
        ...
        try:
            ...
            await asyncio.wait_for(processing_semaphore.acquire(), timeout=1.5)
